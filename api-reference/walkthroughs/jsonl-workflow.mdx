...
<Steps>
  ...
  Create a new project workspace. See [Create Project](/api-reference/projects/post-projects-create) for details.
  ...
  Upload a JSONL file to create a dataset. See [Create Dataset from JSONL](/api-reference/datasets/post-datasets-create-from-jsonl) for details.
  ...
  Poll the dataset status until uploading completes. See [Get Dataset](/api-reference/datasets/get-datasets-datasetid) for details.
