...
**Why This Matters**: Financial YouTube channels contain valuable insights, but this information is locked in video format. This workflow extracts structured intelligence from videos and transforms it into a model that can analyze financial content and output organized data.

**What You'll Build**: A model that analyzes financial video transcripts and outputs clean JSON with:
