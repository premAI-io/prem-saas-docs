...
After this we define our constants. For Prem, we are required to set our `project_id` and `embedding_model`. You can learn more about how to get your `project_id` and API Key from our [API Key guide](/api-reference/api-key).
