...
After [uploading your fine-tuned models to Hugging Face](/guides/general/upload-to-hf), you can deploy them locally as OpenAI-compatible APIs using vLLM. This allows you to serve your custom models with the same interface as OpenAI's API, making integration seamless.
...
- Your model uploaded to Hugging Face (following our [upload guide](/guides/general/upload-to-hf))
...
<Steps>
    ...
    Ensure your Hugging Face model is accessible. For private repositories, make sure you're logged in:
...
<Steps>
    ...
    python -m vllm.entrypoints.openai.api_server \
        --model your-username/your-model-name-full \
        --host 0.0.0.0 \
        --port 8000 \
    ...
    <Info>
        Replace `your-username/your-model-name-full` with your actual Hugging Face model repository name from the upload guide.
    </Info>
    </Step>
