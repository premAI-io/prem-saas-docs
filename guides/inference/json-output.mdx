...
<CodeGroup>
```javascript javascript/typescript
import { ChatCompletionsParams } from "@premai/premai/resources/chat";
import PremAI from "@premai/premai";
...
- If you run into JSON parsing errors, try using the [instructor](https://python.useinstructor.com/) package — it can automatically fix malformed model outputs.
